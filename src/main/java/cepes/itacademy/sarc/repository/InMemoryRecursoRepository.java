...
public class InMemoryRecursoRepository implements RecursoRepository {
    ...
    public InMemoryRecursoRepository() {
        recursos.add(new Notebook("1983", LocalDate.of(2023, 6, 1), "Dell Latitude"));
        recursos.add(new Notebook("1995", LocalDate.of(2023, 6, 1), "Dell Inspiron"));
        recursos.add(new Notebook("2017", LocalDate.of(2024, 2, 15), "Dell Alienware"));
